...
@ActiveProfiles("test")
@Slf4j
class TicketHistoryControllerGetByIdTest {
  ...
  @Test
  void shouldReturn_200_getTicketHistoryById() throws Exception {
    String ticketHistoryId = "54c36c48-2a0e-4db4-9354-1186e8b8c38c";
    ...
    assertEquals(UUID.fromString(ticketHistoryId), responseBody.getId());
    assertEquals("2025-T-30", responseBody.getTicketNumber());
    assertEquals("ticket to update", responseBody.getTicketTitle());
    ...
    assertEquals("2. Verification / Qualification", responseBody.getComment());
    assertEquals("2025-08-18T10:00:00Z", responseBody.getCreated().toString());
  }

  @Test
  void shouldReturn_400_getTicketHistoryById() throws Exception {
  ...
  @Test
  void shouldReturn_401_getTicketHistoryById() throws Exception {
    String ticketHistoryId = "54c36c48-2a0e-4db4-9354-1186e8b8c38c";
    String url = BASE_URL + "/" + ticketHistoryId;
  ...
  @Test
  void shouldReturn_403_getTicketHistoryById() throws Exception {
    String ticketHistoryId = "54c36c48-2a0e-4db4-9354-1186e8b8c38c";
    String url = BASE_URL + "/" + ticketHistoryId;
  ...
  @Test
  void shouldReturn_404_getTicketHistoryById() throws Exception {
  ...
  @Test
  void shouldReturn_404_getTicketHistoryById_isDeletedTrue() throws Exception {
    String ticketHistoryId = "ea20a2e9-7ef4-4376-8c89-6a3a3899a45c";
    String url = BASE_URL + "/" + ticketHistoryId;
    MvcResult response = mockMvc.perform(get(url).with(withJwt())).andReturn();
    int status = response.getResponse().getStatus();

...
public class CompanyAddressController implements CompanyAddressApi {
  ...
  @Override
  public ResponseEntity<CompanyDTO> createCompanyAddress(String authorizationHeader,
      CompanyCreateRequestDTO body) {
    return null;
  }
  ...
  @Override
  public ResponseEntity<CompanyDTO> editCompanyAddressById(String authorizationHeader, UUID id,
      CompanyEditRequestDTO body) {
    return null;
  }

  @Override
  public ResponseEntity<SimpleResponse> deleteCompanyAddressById(String authorizationHeader,
      UUID id) {
    return null;
  }
}

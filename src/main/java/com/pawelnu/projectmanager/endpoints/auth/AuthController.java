...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    if (employeeRepository.existsByUsername(signUpRequest.getUsername())) {
      return ResponseEntity.badRequest().body(new SimpleErrorResponse("Username is already taken!"));
    }
    ...
    EmployeeEntity user = new EmployeeEntity(signUpRequest.getUsername(),
